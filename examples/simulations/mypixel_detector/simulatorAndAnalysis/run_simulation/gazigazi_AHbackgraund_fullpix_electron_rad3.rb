...
def run_simulation(num, random, output)
  ...
  sim.set_database(detector_configuration: "../database/detector_configuration_fullpix.xml",
            detector_parameters: "database/detector_parameters_with_pedestal_generation2.xml")
  ...
  sim.set_primary_generator :AHRadiationBackgroundPrimaryGenSelectExposureTime, {
    particle: "e-",
    filename: "mizuno_GCR_PS_electron.root",
...
### main ###
num = -1
output = "simulation_out_Efeild_fullpix_sield_20mm_mizuno_electron_rad3.root"
random = 0
