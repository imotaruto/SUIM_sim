...
void runExportHistogram() {
    // パラメータの設定
    const char* rootFileName = "simulation_out_Efeild_fullpix_sield_20mm_mizuno_proton_event.root";
    const char* histName = "hXrayEventSpectrum_0_1keVbins";
    const char* outputFileName = "hXrayEventSpectrum_0_1keVbins_proton.txt";
